...
import dev.notonza.shinsei.event.*;
import dev.notonza.shinsei.domain.TaskResult;
import dev.notonza.shinsei.domain.complete_page.CompletePage;
import dev.notonza.shinsei.domain.complete_page.CompletePageSentenceNotSeenException;
import dev.notonza.shinsei.domain.confirm_page.ConfirmPage;
import dev.notonza.shinsei.domain.first_page.FirstPage;
